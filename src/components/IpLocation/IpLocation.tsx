        ...
        <div className={styles.container}>
          ...
          {/* условный рендеринг с помощью оператора логического "И" (&&),
           чтобы отображать элементы в зависимости от наличия данных в переменных error и location. */}
            <button onClick={fetchLocation} disabled={loading} className={styles.button}>
          ...
          {location && (
            <div className={styles.card}>
              ...
              <p><strong>Регион:</strong> {location.regionName}</p>
              <p><strong>Город:</strong> {location.city}</p>
              <p><strong>Широта:</strong> {location.lat}</p>
              <p><strong>Долгота:</strong> {location.lon}</p>
              <p><strong>Провайдер:</strong> {location.isp}</p>
            </div>
          )}
        </div>
      );
